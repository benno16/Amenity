...
public class GeneralSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case GeneralPackage.EVENT: {
				Event event = (Event)theEObject;
				T result = caseEvent(event);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GeneralPackage.DATA_SOURCE: {
				DataSource dataSource = (DataSource)theEObject;
				T result = caseDataSource(dataSource);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GeneralPackage.CONNECTION: {
				Connection connection = (Connection)theEObject;
				T result = caseConnection(connection);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GeneralPackage.CONTAINER: {
				Container container = (Container)theEObject;
				T result = caseContainer(container);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GeneralPackage.SNAPSHOT: {
				Snapshot snapshot = (Snapshot)theEObject;
				T result = caseSnapshot(snapshot);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GeneralPackage.CONTENT_OBJECT: {
				ContentObject contentObject = (ContentObject)theEObject;
				T result = caseContentObject(contentObject);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GeneralPackage.FILE: {
				File file = (File)theEObject;
				T result = caseFile(file);
				if (result == null) result = caseContentObject(file);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GeneralPackage.FOLDER: {
				Folder folder = (Folder)theEObject;
				T result = caseFolder(folder);
				if (result == null) result = caseContentObject(folder);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GeneralPackage.FILE_TYPE: {
			...
			case GeneralPackage.USER_LIST: {
				UserList userList = (UserList)theEObject;
				T result = caseUserList(userList);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GeneralPackage.TASK: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>User List</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>User List</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseUserList(UserList object) {
		return null;
	}
